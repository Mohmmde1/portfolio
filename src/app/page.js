              ...
              <ul className="grid gap-6">
                ...
                <li>
                  <div className="grid gap-1">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Adaptable and thrives in team environments
                    </p>
                  </div>
                </li>
              </ul>
        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <CardDescription>
                    An eCommerce full-stack web application built with Django, Python, and PostgreSQL.
                  </CardDescription>
                </div>
              </CardHeader>
                ...
                <div className="flex items-center gap-4 text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-500 dark:text-gray-400">
                      <Link
                        href="https://github.com/Mohmmde1/techholmes"
                        target="_blank"
                      >
              ...
              <CardContent className="grid gap-2">
                ...
                <div className="flex items-center gap-4 text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-500 dark:text-gray-400">
                      <Link
                        href="https://github.com/Mohmmde1/portfolio"
                        target="_blank"
                      >
                        {' '}View on GitHub
                      </Link>
            ...
            <Card>
              ...
              <CardContent className="grid gap-2">
                <div className="text-sm font-semibold">
                Developed with Django that allows users to upload images and perform object detection on them and count the specified object.
                </div>
                <div className="flex items-center gap-4 text-sm">
                  <div className="flex items-center gap-1">
                    <GithubIcon className="w-4 h-4" />
                    <span className="text-gray-500 dark:text-gray-400">
                      <Link
                        href="https://github.com/Mohmmde1/objs-counter"
                        target="_blank"
                      >
                        {' '}View on GitHub{' '}
                      </Link>
